...
function Dining(){
    return(
        <div className="dining_Container"> 
            ...
            <p className="dining_Paragraph">Savor the art of detectable cuisine at our restaurant.Elevate your taste journey with a perfect blend of 
            taste, prepared with passion and served with excellence. Experience a cuilinary escape that delights 
            the senses.</p>

            <p className="dining_Paragraph">Indulge in a gastronomic adventure at our restaurant, where every dish tells a story of creativity and 
            craftsmanship. From locally sourced ingredients to exquisite presentations, we're dedicated to offering a
            dining experience that transcends expectations. Immerse yourself in an ambiance that celebrates 
